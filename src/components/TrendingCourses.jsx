      ...
      <div className="mb-12">
        ...
        <h2 className="font-bold text-3xl text-[#2B2B2B]">
          ...
          <span className="text-[#1DA077] ">What's Hot Right Now! <span>
            <Image src="/flames-icon.svg" alt="flameicon" height={25} width={25} className="inline-block object-contain -mt-2"></Image>
            </span></span>
        </h2>
      </div>
...
function VerticalCard({ title, description, number, color, textColor }) {
  return (
    <div className="bg-[#F9EBEC] rounded-2xl p-8 text-[#C33241] flex flex-col items-center justify-center gap-10  min-h-[250px]">
      ...
      <div className="relative w-[150px] text-[150px] font-bold leading-none ">
        {number}<span className="absolute -top-7 -right-8 text-[64px]">+</span>
      </div>
    </div>
  );
}
